        ...
        <div class="mx-auto max-w-4xl">
          <div class="">
            ...
            <div class="flex items-center pt-5 md:pt-10">
              ...
              <div class="pl-5">
                <span class="block font-body text-xl font-bold text-grey-10">By Harjot Singh</span>
          ...
          <div class="mt-10 flex justify-between border-t border-lila py-12">
            <a href="/blogs" class="flex items-center">
          ...
          <div
            ...
            <div class="ml-0 text-center md:ml-10 md:w-5/6 md:text-left">
              ...
              <div class="flex items-center justify-center pt-5 md:justify-start">
                ...
                <a href="https://discord.gg/GSuMupvhJ2" target="_blank" className="pl-4">
                  <i className="bx bxl-discord text-2xl text-primary hover:text-yellow"></i>
                </a>
                <a href="https://www.linkedin.com/in/harjot-singh-9b0672210/" target="_blank" className="pl-4">
                  <i className="bx bxl-linkedin text-2xl text-primary hover:text-yellow"></i>
                </a>
                <a href="https://www.instagram.com/harjot_._singh/" target="_blank" className="pl-4">
    ...
    <div class="bg-primary">
      <div class="container flex flex-col justify-between py-6 sm:flex-row">
        ...
        <div class="flex items-center justify-center pt-5 sm:justify-start sm:pt-0">
          ...
          <a href="https://discord.gg/GSuMupvhJ2" target="_blank" className="pl-4">
            <i className="bx bxl-discord text-2xl text-white hover:text-yellow"></i>
          </a>
          <a href="https://www.linkedin.com/in/harjot-singh-9b0672210/" target="_blank" className="pl-4">
